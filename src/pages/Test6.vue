<template>
    <div   class='all_bg' >
        <div  class='test_middle' >
            ...
            <div  class='test_inbetweening animate__animated animate__bounceIn' style="animation-delay:0.5s;"></div>
...
.test_option{
    width:268px;
    height:43px;
    background:url('../assets/images/question6.png') no-repeat center;
    background-size: cover;
    margin: 145px 24px 0 35px;
}
.question_A {
    width:261px;
    height:67px;
    background:url('../assets/images/question6A.png') no-repeat center;
    background-size: cover;
    margin: 18px 29px 0 36px;
}
.question_B {
    width:261px;
    height:98px;
    background:url('../assets/images/question6B.png') no-repeat center;
    background-size: cover;
    margin: 15px 29px 46px 36px;
}
.question_C {
    width:261px;
    height:67px;
    background:url('../assets/images/question6C.png') no-repeat center;
    background-size: cover;
...
.test_inbetweening {
    ...
    width:115px;
    height:156px;
    background:url('../assets/images/inbetweening3.png') no-repeat center;
    background-size: cover;
}
